...
class OnBoardingScreen : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        OnBoardIngData.add(OnBoardIngItems(R.drawable.topic_display,"Различные темы для викторины"))
        OnBoardIngData.add(OnBoardIngItems(R.drawable.questions_display,"Простой пользовательский интерфейс для викторины"))
